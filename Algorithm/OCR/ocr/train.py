...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', default='data_lmdb_release/trainingNoPoint', help='path to training dataset')
    parser.add_argument('--valid_data', default='data_lmdb_release/validationNoPoint', help='path to validation dataset')
